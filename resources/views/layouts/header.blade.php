                    ...
                    <div class="user-box dropdown px-3">
                        <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <div class="user-info">
                                ...
                                <p class="designattion mb-0">{{ Auth::user()->getOrg->name }} {{ Auth::user()->getRole->name }}</p>
                            </div>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end">
                            @if(Auth::user()->role == 1))
                            	<li><a class="dropdown-item d-flex align-items-center" href="/users"><i class="bx bx-user fs-5"></i><span>Users</span></a>
                            	</li>
                            @endif
